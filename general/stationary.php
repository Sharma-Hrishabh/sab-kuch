...
<body>
	...
	<div class="container">
<?php
$connect=mysqli_connect('localhost','root','','gnrlneeds');
 ...
 if(mysqli_num_rows($result)>0):
 	while($product=mysqli_fetch_assoc($result)):
 		...
 		<div class="col-sm-4 col-md-3" style="margin-top: 160px">
 			<form method="post" action="stationary.php?action=add&id=<?php echo $product['id']; ?>">
                        <div class="products">
...
?><div style="clear:both"></div>  
        ...
        <tr>  
           ...
           <td>
               <a href="stationary.php?action=delete&id=<?php echo $product['id']; ?>">
